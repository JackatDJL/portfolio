...
\newcommand{\sectiontitle}[1]{\Needspace{45mm}\vspace{2.2mm}{\fontsize{15}{16}\selectfont\bfseries #1}\par\nopagebreak\vspace{1mm}{\color{rule}\rule{\linewidth}{.45pt}}\par\nopagebreak\vspace{.4mm}}
\newcommand{\entry}[5]{\noindent\begin{minipage}{\linewidth}\fontsize{11}{13}\selectfont\begin{tabularx}{\linewidth}{@{}>{\raggedright\arraybackslash}X>{\raggedleft\arraybackslash}p{30mm}@{}}\strut\textbf{\href{#4}{#1}}&\strut{\fontsize{8.2}{13}\selectfont\color{muted}#2}\\[-.8mm]\end{tabularx}\par{\fontsize{9}{11}\selectfont\bfseries #3}\par\vspace{.8mm}{\fontsize{9.5}{12.2}\selectfont\color{muted}\raggedright #5\par}\end{minipage}\par\vspace{4mm}}
...
\begin{tikzpicture}[x=1mm,y=1mm]
  ...
  @if($cv['profile'])\node[anchor=west,inner sep=0pt] at (73,8) {\fontsize{7}{8}\selectfont\href{ {{ $cv['canonical_url'] }} }{Interaktive Version \ensuremath{\nearrow}}};@endif
...
\vfill{\fontsize{7.2}{8.5}\selectfont\color{muted}Interaktive Version: \href{ {{ $cv['canonical_url'] }} }{ {{ $e(preg_replace('#^https?://#', '', $cv['canonical_url'])) }} }}
\end{paracol}
\end{document}
